...
class Project2:
    ...
    def app(self):
        ...
        source_option = st.selectbox("Pick up source of the video stream", ("Mobile camera", "YouTube link", "Local drive", "Web-camera", "RTSP"))
        video_url = None
        img_file = None
            ...
            if youtube_url:
                with st.spinner("Video is uploading"):
                    try:
                        ...
                        st.error(f"Something is wrong: {ex}")
        ...
        if source_option == "Mobile_camera" and img_file is not None:
